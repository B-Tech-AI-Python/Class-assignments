...
if __name__ == "__main__":
    ...
    #Add constraints to the given MAP problem
    csp.add_constraint(MapColoringConstraint("BOX_1", "BOX_2"))
    csp.add_constraint(MapColoringConstraint("BOX_1", "BOX_5"))
    csp.add_constraint(MapColoringConstraint("BOX_2", "BOX_3"))
    csp.add_constraint(MapColoringConstraint("BOX_2", "BOX_6"))
    csp.add_constraint(MapColoringConstraint("BOX_3", "BOX_4"))
    csp.add_constraint(MapColoringConstraint("BOX_3", "BOX_6"))
    csp.add_constraint(MapColoringConstraint("BOX_4", "BOX_6"))
    csp.add_constraint(MapColoringConstraint("BOX_5", "BOX_6"))
    csp.add_constraint(MapColoringConstraint("BOX_5", "BOX_7"))
    csp.add_constraint(MapColoringConstraint("BOX_6", "BOX_8"))
    csp.add_constraint(MapColoringConstraint("BOX_7", "BOX_8"))
    csp.add_constraint(MapColoringConstraint("BOX_7", "BOX_9"))
    csp.add_constraint(MapColoringConstraint("BOX_8", "BOX_9"))
